...
UBYTE FcbFindFirst(xfcb FAR * lpXfcb)
{
  ...
  ____dmatch_ff.dm_drive = lpFcb->fcb_sftno;
  ...
  ____dmatch_ff.dm_attr_srch = wAttr;
  ____dmatch_ff.dm_entry = lpFcb->fcb_strtclst;
  ____dmatch_ff.dm_dircluster = lpFcb->fcb_dirclst;
